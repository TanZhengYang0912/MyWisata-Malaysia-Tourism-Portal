...
// { title, body } for the admin's existing KB form to prefill; never saves
// anything itself (see lib/chatbot/kb-draft.ts's header). Gated on
// super_admin/approver, same as every other /admin/chatbot route.
