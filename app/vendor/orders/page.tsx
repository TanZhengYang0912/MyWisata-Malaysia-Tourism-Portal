...
export default function VendorOrdersPage() {
  ...
  return (
    <div className="space-y-5">
      <header><div className="mb-2 inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.18em] text-primary"><ShoppingBag size={15} /> {t('ui.orders.fulfilmentDesk')}</div><h1 className="text-2xl font-bold tracking-tight text-gray-950">{t('ui.orders.title')}</h1><p className="mt-1 text-sm text-gray-500">{t('ui.orders.description')}</p></header>
