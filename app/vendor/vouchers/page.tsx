    ...
    <div className="space-y-5">
      ...
      <section className="rounded-2xl border border-amber-100 bg-amber-50/50 p-4">
        ...
        <div className="mt-4 grid gap-2 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-7">
          ...
          <div className="rounded-xl bg-white px-3 py-2"><p className="text-[11px] text-gray-500">{t('ui.vouchers.salesGenerated')}</p><p className="mt-1 font-bold text-gray-900">RM {analyticsTotals.revenue.toFixed(2)}</p></div>
          <div className="rounded-xl bg-white px-3 py-2"><p className="text-[11px] text-gray-500">{t('ui.vouchers.discountCost')}</p><p className="mt-1 font-bold text-gray-900">RM {analyticsTotals.discount.toFixed(2)}</p></div>
          <div className="rounded-xl bg-white px-3 py-2"><p className="text-[11px] text-gray-500">{t('ui.vouchers.netRevenueImpact')}</p><p className="mt-1 font-bold text-primary">RM {analyticsTotals.revenueImpact.toFixed(2)}</p></div>
        </div>
