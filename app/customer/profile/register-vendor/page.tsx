    ...
    return (
      <CustomerPageShell>
        <CustomerPanel className="p-6 md:p-8">
          ...
          <CustomerPageHeader eyebrow={t('ui.profile.vendorApplication', { defaultValue: 'Vendor application' })} title={vendor.name} description={t(`ui.profile.vendorStatus.${vendor.status}`, { defaultValue: status.description })} icon={<Store size={14} />} className="mb-6" />
