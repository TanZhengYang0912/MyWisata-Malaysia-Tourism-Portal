...
function LocationCard({ location, vendorId }: { location: LocationSummary; vendorId: string }) {
  ...
  return <article className="mw-card group min-w-0 transition-all duration-300 hover:-translate-y-1 hover:border-primary/40 hover:shadow-lg">
    <div className="mw-card-media flex h-36 aspect-auto items-center justify-center bg-gradient-to-br from-[#010066] via-[#172b72] to-[#2d5273]"><span className="flex h-16 w-16 items-center justify-center rounded-2xl border border-white/35 bg-white/15 text-2xl font-black text-white shadow-xl backdrop-blur-sm transition-transform duration-500 group-hover:scale-[1.02]">{visual.initials}</span><span className="absolute bottom-3 text-[10px] font-bold uppercase tracking-[0.2em] text-white/90">Outlet identity</span><span className="absolute left-3 top-3 inline-flex items-center gap-1 rounded-full bg-white/95 px-2.5 py-1 text-[11px] font-bold text-emerald-700"><span className="h-1.5 w-1.5 rounded-full bg-emerald-500" /> Active outlet</span></div>
