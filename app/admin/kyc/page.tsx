...
export default function AdminKycPage() {
  ...
  return <main className="min-h-full bg-background px-4 py-6 sm:px-6 sm:py-8 xl:px-8">
    <header><div className="flex items-center gap-2 text-primary"><ShieldCheck size={18} /><p className="text-xs font-semibold uppercase tracking-[0.18em]">{t("kyc.eyebrow")}</p></div><h1 className="mt-2 font-[family-name:var(--font-display)] text-3xl font-bold tracking-[-0.04em] text-foreground sm:text-4xl">{t("kyc.title")}</h1><p className="mt-1 max-w-2xl text-sm text-muted-foreground">{t("kyc.description")}</p></header>
