...
export default function AdminKycPage() {
  ...
  async function applyBatch(action: "approve" | "request_info" | "reject") {
    ...
    if (action !== "approve") {
      const enteredCode = window.prompt(t("kyc.prompts.reasonCode", { reasons: KYC_REVIEW_REASON_CODES.join(", ") }), "other")?.trim() as KycReviewReasonCode | undefined;
