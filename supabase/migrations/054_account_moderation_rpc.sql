-- Keep account-management mutations behind the Next.js moderation boundary.
-- The service-role client calls this function after Gemini approves the text.

DROP FUNCTION IF EXISTS public.admin_manage_user(UUID, TEXT, TEXT);
