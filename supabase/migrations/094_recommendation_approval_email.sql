-- Allow approved recommendation notifications in the durable email outbox.
...
ALTER TABLE public.email_outbox
  ADD CONSTRAINT email_outbox_event_type_check CHECK (event_type IN (
    ...
    'recommendation_reward_reversed', 'recommendation_approved',
    'account_suspended', 'account_unsuspended', 'account_deleted',
    'account_restored', 'vendor_order_update', 'vendor_booking_update',
    'vendor_listing_review', 'vendor_wallet_update', 'vendor_account_update',
