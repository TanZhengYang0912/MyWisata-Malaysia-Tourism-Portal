-- Restore the outlet welcome-message contract that is consumed by the vendor portal.
-- This is safe to apply when a deployment already has either column/function.
