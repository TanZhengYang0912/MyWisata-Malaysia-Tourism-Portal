-- Additive voucher integrity guard. Existing rows and checkout states are preserved.
-- This replaces the latest prepare_checkout implementation without changing its signature.
