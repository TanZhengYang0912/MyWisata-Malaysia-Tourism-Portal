...
CREATE INDEX IF NOT EXISTS vendor_voucher_csv_drafts_vendor_updated_idx ON public.vendor_voucher_csv_drafts (vendor_id, updated_at DESC);
...
CREATE POLICY vendor_voucher_csv_drafts_service_only ON public.vendor_voucher_csv_drafts FOR ALL TO service_role USING (true) WITH CHECK (true);
