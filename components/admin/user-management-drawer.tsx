...
const ROLE_LABELS: Record<string, string> = {
  customer: "userManagement.roles.customer",
  vendor_owner: "userManagement.roles.vendorOwner",
  outlet_manager: "userManagement.roles.outletManager",
};

const AUDIT_ACTION_LABELS: Record<string, string> = {
  "user_management.clear_bio_restriction": "userManagement.auditActions.clearBioRestriction",
  "user_management.suspend": "userManagement.auditActions.suspend",
  "user_management.unsuspend": "userManagement.auditActions.unsuspend",
  "user_management.soft_delete": "userManagement.auditActions.softDelete",
  "user_management.restore": "userManagement.auditActions.restore",
};
    ...
    <aside className="relative z-10 max-h-[calc(100vh-2rem)] w-full max-w-2xl overflow-y-auto rounded-2xl border border-border bg-card p-5 shadow-2xl sm:max-h-[calc(100vh-3rem)] sm:p-6">
      ...
      {detail && <div className="mt-5 space-y-5">
        ...
        <div className="grid gap-3 sm:grid-cols-2">{[
          ...
          ["userManagement.fields.profile", detail.profileComplete ? t("userManagement.complete") : t("userManagement.incomplete")], ["userManagement.fields.kyc", t(`ui.users.status.${detail.kycStatus}`)],
