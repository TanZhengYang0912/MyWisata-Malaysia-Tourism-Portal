    ...
    >
      ...
      <div className="mw-card-body space-y-2 p-4">
        ...
        <div className="mw-card-footer pt-1">
          <div><ReferencePrice amountMYR={Number(activity.price)} className="font-[family-name:var(--font-mono)] text-lg font-bold text-primary" /><span className="ml-1 text-xs text-muted-foreground">/ {t("ui.labels.person")}</span></div>
