      ...
      <div className="space-y-3 p-4">
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            <Link href={`/customer?state=${encodeURIComponent(destination.state)}`} className="rounded-full bg-primary px-3 py-1.5 text-xs font-bold text-white transition hover:bg-primary/90">{t("ui.actions.viewDetails")}</Link>
