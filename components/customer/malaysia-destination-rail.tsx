            ...
            <div>
              ...
              <div className="mt-5 min-w-0 overflow-hidden pb-2" aria-label={t("ui.map.destinationCards")}>
                ...
                {getVisibleDestinationQueue(queue, activeId, 5).map((destination) => (
                  ...
                  >
                    {/* eslint-disable-next-line @next/next/no-img-element */}
                    <img src={destination.image} alt={`${destination.attraction}, ${destination.state}`} loading="lazy" className="absolute inset-0 h-full w-full object-cover object-top saturate-[1.35] contrast-[1.08] brightness-[1.05] transition duration-700 group-hover:scale-105" />
