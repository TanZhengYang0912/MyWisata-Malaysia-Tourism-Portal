                ...
                <div className="mt-5 border-t border-slate-200 pt-4">
                  <div className="flex items-center justify-between gap-3">
                    <div>
                      ...
                      <p className="mt-0.5 text-xs text-slate-500">Open a booking to see its details.</p>
                    </div>
                    <span className="hidden rounded-full bg-secondary px-2.5 py-1 text-[10px] font-bold uppercase tracking-[0.1em] text-primary sm:inline-flex">Open a booking</span>
                  </div>
                    ...
                    {group.bookings.map((booking, index) => (
                      ...
                      >
                        ...
                        <span className="min-w-0 flex-1">
                          <span className="block text-[10px] font-bold uppercase tracking-[0.1em] text-slate-400">Booking</span>
                          <span className="block truncate text-xs font-bold text-slate-800">Booking {String(index + 1).padStart(2, "0")}</span>
                        </span>
                        <span className="inline-flex shrink-0 items-center gap-1 text-[10px] font-bold text-primary">View booking <ArrowUpRight size={13} aria-hidden="true" /></span>
                      </Link>
                    ))}
                  </div>
                </div>
