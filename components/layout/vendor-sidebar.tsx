  ...
  return (
    <aside className="fixed top-0 left-0 bottom-0 w-60 bg-gray-900 text-gray-200 flex flex-col z-40">
      <div className="px-5 py-5 border-b border-gray-700">
        ...
        {!loading && isOutletManager && <p className="mt-2 inline-flex items-center gap-1.5 rounded-full bg-gray-800 px-2 py-1 text-[10px] font-semibold uppercase tracking-wide text-gray-300"><ShieldCheck size={11} /> {tVendor('shell.outletOperations', { defaultValue: 'Outlet operations' })}</p>}
