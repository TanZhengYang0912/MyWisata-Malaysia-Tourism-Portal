...
export function ProfileSections() {
  ...
  async function loadProfile() {
    ...
    try {
      ...
      setInterests(next.survey?.interests ?? []); setTravelStyle(next.survey?.travelStyle ?? "solo"); setBudgetRange(next.survey?.budgetRange ?? "mid_range"); setMobilityNeeds(next.survey?.mobilityNeeds ?? "none"); setPreferredDistance(next.survey?.preferredDistance ?? "no_preference");
      setError(null);
