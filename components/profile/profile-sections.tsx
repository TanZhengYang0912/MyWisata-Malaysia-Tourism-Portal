...
export function ProfileSections({ shellClassName, showHeader = true }: { shellClassName?: string; showHeader?: boolean } = {}) {
  ...
  async function uploadAvatar() {
    ...
    try {
      ...
      if (!signed.ok) throw new Error(tCustomer("ui.profileWizard.avatarUploadUrlError"));
      ...
      if (!upload.ok) throw new Error(tCustomer("ui.profileWizard.avatarStorageError"));
      ...
      if (!confirmed.ok) throw new Error(tCustomer("ui.profileWizard.avatarConfirmError"));
